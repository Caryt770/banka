...
export class UslugaComponent implements OnInit, OnChanges {
  ...
  ngOnChanges(): void {
    if(this.selektovaniKorisnik && this.selektovaniKorisnik.id){
      this.loadData();
    }
  }
  ...
  private podesiTabelu(data: Usluga[]) {
